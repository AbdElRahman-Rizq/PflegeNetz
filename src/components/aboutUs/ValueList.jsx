  ...
  const values = [
    {
      title: "Excellence",
      description:
        "We strive to achieve the highest standards in all aspects of our work.",
    },
    {
      title: "Trust",
      description:
        "Transparent communication and reliability are the foundation of our actions.",
    },
    {
      title: "Innovation",
      description:
        "Using modern approaches and technologies, we set new benchmarks in recruitment.",
    },
    {
      title: "Sustainability",
      description:
        "We create long-term connections that benefit all parties involved.",
    },
  ];
